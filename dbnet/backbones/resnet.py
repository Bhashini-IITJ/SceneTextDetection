...
def resnet34(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(
            model_urls['resnet34'], map_location = torch.device('cuda:0')), strict=False)
    return model
...
def deformable_resnet50(pretrained=True, **kwargs):
    ...
    model.to(torch.device('cuda:0'))  # Ensure the model is on the specified device
    return model
...
def resnet101(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(
            model_urls['resnet101'], map_location = torch.device('cuda:0')), strict=False)
    return model
